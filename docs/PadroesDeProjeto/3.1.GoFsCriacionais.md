...
A construção inicial desse diagrama ficou encarregada ao [Lucas Ricarte](https://github.com/Lucas-Ricarte) e iremos aperfeiçoar com os demais componetes do grupo durante o desenvolvimento da entrega.
